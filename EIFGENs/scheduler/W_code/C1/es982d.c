...
static const EIF_TYPE_INDEX egt_17_982 [] = {0xFF01,899,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_982[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13753, 32},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13754, 33},
	{EIF_GENERIC(egt_14_982), 13755, 0},
	{EIF_GENERIC(egt_15_982), 13756, 8},
	{EIF_GENERIC(egt_16_982), 13757, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13758, 36},
	{EIF_GENERIC(egt_17_982), 13763, 24},
};
void Init982(void)
{
	IDSC(desc_982, 0, 981);
