...
extern EIF_TYPED_VALUE F973_7411(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {TIME_UTILITY}.div */
EIF_TYPED_VALUE F973_7411 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 972, Current, 0, 2, 13697);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 972, Current, 0, 0, 13699);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
